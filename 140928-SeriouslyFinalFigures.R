...
#Figure2:  
#makeTargetPlot(makerefmetdfb(norm="UQN"))
...
makeseqcdf<-function(){
  ...
  for ( I in c("AGR","BGI","CNL","COH","MAY","NVS")){
    string<-paste("~/Desktop/MainSEQC/SEQC_MAIN_ILM_rawCounts_ZSu.2012_04_14/SEQC_MAIN_ILM_",I,"_TranscriptCounts_ZSU.txt",sep="")
    tdf<-fread(string)
